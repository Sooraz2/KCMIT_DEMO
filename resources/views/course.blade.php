            ...
            <div class="row mb-30">
                <div class="col-lg-8 col-md-12">
                    <div class="detail-img">
                        <img src="{{asset('images\courses\courses-details.jpg')}}" alt="Courses Images" />
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="course-meta-style">
                                <li class="author">
                                    <div class="image">
                                        <img src="{{asset('images\teachers\2.jpg')}}" width="60"  alt="">
                                    </div>
                                ...
                                <div class="tab-content card">
                                    ...
                                    <div class="tab-pane fade" id="instructors" role="tabpanel">
                                        <div class="instructor-list">
                                            <div class="image">
                                                <img src="{{asset('images\teachers\2.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                        ...
                                        <div class="instructor-list pt-45">
                                            <div class="image">
                                                <img src="{{asset('images\teachers\9.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                        ...
                                        <div class="instructor-list pt-45">
                                            <div class="image">
                                                <img src="{{asset('images/teachers/6.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                    ...
                                    <div class="tab-pane fade" id="review" role="tabpanel">
                                        ...
                                        <div class="instructor-list">
                                            <div class="image">
                                                <img src="{{asset('images/teachers/8.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                                <div class="client-rating">
                                                    <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i>
                                        ...
                                        <div class="instructor-list mt-15">
                                            <div class="image">
                                                <img src="{{asset('images/teachers/7.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                                <div class="client-rating">
                                                    <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i>
                                        ...
                                        <div class="instructor-list mt-15">
                                            <div class="image">
                                                <img src="{{asset('images/teachers/4.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                                <div class="client-rating">
                                                    <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="sidebar-area">
                        ...
                        <div class="latest-courses">
                            ...
                            <div class="post-item">
                                <div class="post-img">
                                    <a href="courses-details.html"><img src="{{asset('images\blog-details\sm1.jpg')}}" alt="" title="News image"></a>
                                </div>
                                <div class="post-desc">
                            ...
                            <div class="post-item">
                                <div class="post-img">
                                    <a href="courses-details.html"><img src="{{asset('images\blog-details\sm2.jpg')}}" alt="" title="News image"></a>
                                </div>
                                <div class="post-desc">
                                    <h4><a href="courses-details.html">Raken develops reporting The software</a></h4>
	                                    <span class="duration">
                            ...
                            <div class="post-item">
                                <div class="post-img">
                                    <a href="courses-details.html"><img src="{{asset('images\blog-details\sm3.jpg')}}" alt="" title="News image"></a>
                                </div>
                                <div class="post-desc">
                                    <h4><a href="courses-details.html">Raken develops reporting The software</a></h4>
	                                    <span class="duration">
        ...
        <div class="container pt-45">
            ...
            <div class="related-courses rs-courses-3">
                ...
                <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="1500" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-ipad-device="2" data-ipad-device-nav="true" data-md-device="3" data-md-device-nav="true">
                    ...
                    <div class="course-item">
                        <div class="course-img">
                            <img src="{{asset('images/courses/11.jpg')}}" alt="" />
                            <span class="course-value">$450</span>
                            <div class="course-toolbar">
                    ...
                    <div class="course-item">
                        <div class="course-img">
                            <img src="{{asset('images/courses/13.jpg')}}" alt="" />
                            <span class="course-value">$450</span>
                            <div class="course-toolbar">
